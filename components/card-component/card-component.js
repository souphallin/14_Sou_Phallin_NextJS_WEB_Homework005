  ...
  return (
    <>
        <Link href="#" className="cursor-pointer">
          <section className="flex items-center justify-center bg-opacity-25 mt-20">
            <div className=" bg-white rounded-xl border border-[#e6e6e6] font-['Poppins'] p-3 flex gap-10">
              <div className=" grid grid-cols-7 gap-4">
                <div className="relative col-span-3 flex flex-col justify-between h-[140px]">
                  <div className="">
                    <img
                      className="absolute -top-[115px] h-52 w-52 rounded-2xl"
                      src={items.image}
                      alt=""
                    />
                  </div>
                  <Button className=" rounded-full text-sm bg-[#BFD7EA] text-[#0B3954]">
                    READ FULL ARTICLE
                  </Button>
                </div>
